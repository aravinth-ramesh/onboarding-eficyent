        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    <tr>
                        <td style="background-color: #8a6d1a; padding: 24px 32px;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 20px; font-weight: 600;">Eficyent — Compliance</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 32px;">
                            <h2 style="margin: 0 0 16px; font-size: 18px; color: #8a6d1a;">An application was escalated to compliance</h2>
                            <p style="margin: 0 0 16px; color: #333333; line-height: 1.6;">
                                @if($escalatedBy)
                                    {{ $escalatedBy->name }} escalated the following application for a compliance decision:
                                @else
                                    The following application was escalated for a compliance decision:
                                @endif
                            </p>
                            ...
                            @if($note)
                                <p style="margin: 16px 0 0; padding: 12px 16px; background-color: #fff8e6; border-left: 3px solid #8a6d1a; color: #333333; line-height: 1.6; font-style: italic;">
                                    “{{ $note }}”
                                </p>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 32px 32px;" align="center">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color: #8a6d1a; border-radius: 6px;">
