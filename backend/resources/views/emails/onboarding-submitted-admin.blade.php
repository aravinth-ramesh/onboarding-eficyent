                                ...
                                <tr>
                                    <td style="padding: 16px 20px; font-size: 14px; color: #333333; line-height: 1.9;">
                                        ...
                                        @if($onboarding->userType)
                                            <strong>Type:</strong> {{ $onboarding->userType->name }}@if($onboarding->subcategory) — {{ $onboarding->subcategory->name }}@endif<br>
                                        @endif
                                        <strong>Submitted:</strong> {{ $onboarding->completed_at?->format('M d, Y H:i') }} (UTC)
                                    </td>
                                </tr>
                            </table>
                        </td>
