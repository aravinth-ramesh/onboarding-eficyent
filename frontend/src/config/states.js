// State / province lists for the address field, keyed by ISO country code.
// Countries not listed here fall back to a free-text state/province input.
export const STATES_BY_COUNTRY = {
  ...
  MY: ['Johor', 'Kedah', 'Kelantan', 'Malacca', 'Negeri Sembilan', 'Pahang', 'Penang', 'Perak', 'Perlis', 'Sabah', 'Sarawak', 'Selangor', 'Terengganu', 'Kuala Lumpur', 'Labuan', 'Putrajaya'],
};

export function statesFor(iso) {
  return STATES_BY_COUNTRY[iso] || null;
}
